...
The goal was to scale 2 pods at once if the scaling condition is fulfilled. Only the `hpa.yaml` in incomplete. You can find a solution in the `hpa-solution.yaml`.
